                    ...
                    <table className="w-full table-auto text-center text-lg">
                        <thead>
                            <tr className="bg-[#3b3f5c] text-[#b0b3c8]">
                                <th className="py-4 font-semibold uppercase tracking-wider">Rank</th>
                                <th className="py-4 font-semibold uppercase tracking-wider">Username</th>
                                <th className="py-4 font-semibold uppercase tracking-wider">Highest WPM</th>
                                <th className="py-4 font-semibold uppercase tracking-wider">Role</th>
                            </tr>
                        </thead>
                        <tbody>
                            {leaderboard[0]?.rankings?.map((player, index) => (
                                player ? (
                                    <tr key={player.id} className="hover:bg-[#393d56] transition duration-200">
                                        <td className="py-4 text-[#8e97f0] font-medium">{index + 1}</td>
                                        <td className="py-4 font-semibold text-[#d4d7f2]">{player.username}</td>
                                        <td className="py-4 text-[#49a8b8] font-bold">{player.highestWPM}</td>
