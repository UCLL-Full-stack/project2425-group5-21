  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Select your game mode to start playing!" />
      ...
      <main className="h-screen bg-[#120e17] flex flex-col justify-center items-center text-white relative">
        <div className="absolute top-0 left-0 w-full h-full bg-cover bg-no-repeat bg-center z-0" style={{ backgroundImage: 'url(/path/to/your-background-image.png)' }} />
        
        <div className="z-10 w-full max-w-5xl flex flex-col items-center justify-center space-y-8 px-6 py-10">
          <h1 className="text-5xl font-extrabold mb-4 text-center">Welcome to MR Typer!</h1>
          <p className="text-lg text-center max-w-3xl mb-8">Choose your game mode to start typing! Whether you want to play solo or with friends, the fun begins here. Let’s see how fast you can type!</p>
          ...
          <div className="flex space-x-8 justify-center mb-8 w-full">
            ...
            >
              ...
              <p className="text-sm mt-2">Play solo and challenge yourself to improve your typing skills.</p>
            </div>
            ...
            >
              ...
              <p className="text-sm mt-2">Compete with friends or players around the world in real-time!</p>
            </div>
          </div>
          ...
          {error && (
            <p className="text-red-400 font-semibold text-xl mt-4">
              {error}
            </p>
          )}
        </div>
