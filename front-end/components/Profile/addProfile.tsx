...
const AddProfileForm: React.FC<{ onProfileAdded: () => void }> = ({
  onProfileAdded,
}) => {
  ...
  return (
    <form
      ...
      className="bg-[#2a2d40] p-6 rounded-lg shadow-lg text-white w-11/12 max-w-4xl mb-10"
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="mb-4">
          <label
            htmlFor="username"
            className="block text-[#b0b3c8] font-semibold"
          >
            Username
          </label>
          <input
        ...
        <div className="mb-4">
          <label htmlFor="bio" className="block text-[#b0b3c8] font-semibold">
            Bio
          </label>
          <input
            type="text"
        ...
        <div className="mb-4 col-span-1 sm:col-span-2 lg:col-span-1">
          <label htmlFor="role" className="block text-[#b0b3c8] font-semibold">
            Role
          </label>
          <select
            name="role"
